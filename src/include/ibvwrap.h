...
class IbvWrapper {
  public:
    IbvWrapper(bool mock) : mock_(mock) {}
    ...
    ncclResult_t wrap_ibv_poll_cq(struct ibv_cq *cq, int num_entries, struct ibv_wc *wc, int* num_done);
...
extern std::shared_ptr<IbvWrapper> ibvWrapper;
