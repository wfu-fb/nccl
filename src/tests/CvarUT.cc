...
TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_0) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", 0);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, 0);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_1) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", 9999);
...
TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_2) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", std::numeric_limits<uint64_t>::max());
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, std::numeric_limits<uint64_t>::max());
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_3) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", std::numeric_limits<uint64_t>::min());
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, std::numeric_limits<uint64_t>::min());
}
...
TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS_value_0) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS", 0);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS, 0);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS_value_1) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS", 9999);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS, 9999);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS_value_2) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS", std::numeric_limits<uint64_t>::max());
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS, std::numeric_limits<uint64_t>::max());
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS_value_3) {
  testNumValue<uint64_t>("NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS", std::numeric_limits<uint64_t>::min());
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS, std::numeric_limits<uint64_t>::min());
}
