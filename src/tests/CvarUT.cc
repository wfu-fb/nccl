...
TEST_F(CvarTest, NCCL_ALLGATHER_DIRECT_CUTOFF_value_2) {
  testIntValue("NCCL_ALLGATHER_DIRECT_CUTOFF", UINT64_MAX);
  EXPECT_EQ(NCCL_ALLGATHER_DIRECT_CUTOFF, UINT64_MAX);
}
...
TEST_F(CvarTest, NCCL_CTRAN_IB_QP_SCALING_THRESHOLD_value_2) {
  testIntValue("NCCL_CTRAN_IB_QP_SCALING_THRESHOLD", UINT64_MAX);
  EXPECT_EQ(NCCL_CTRAN_IB_QP_SCALING_THRESHOLD, UINT64_MAX);
}
...
TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_MAX_BLOCKS_value_0) {
  testIntValue("NCCL_DDA2_ALLREDUCE_MAX_BLOCKS", -100);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_MAX_BLOCKS, -100);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_MAX_BLOCKS_value_1) {
  testIntValue("NCCL_DDA2_ALLREDUCE_MAX_BLOCKS", 0);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_MAX_BLOCKS, 0);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_MAX_BLOCKS_value_2) {
  testIntValue("NCCL_DDA2_ALLREDUCE_MAX_BLOCKS", 9999);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_MAX_BLOCKS, 9999);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_MAX_BLOCKS_value_3) {
  testIntValue("NCCL_DDA2_ALLREDUCE_MAX_BLOCKS", INT_MAX);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_MAX_BLOCKS, INT_MAX);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_MAX_BLOCKS_value_4) {
  testIntValue("NCCL_DDA2_ALLREDUCE_MAX_BLOCKS", INT_MIN);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_MAX_BLOCKS, INT_MIN);
}
...
TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_0) {
  testIntValue("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", 0);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, 0);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_1) {
  testIntValue("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", 9999);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, 9999);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_value_2) {
  testIntValue("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS", UINT64_MAX);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, UINT64_MAX);
}

TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS_default_value) {
  testDefaultValue("NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS");
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_SCATGAT_THRESHOLD_NVS, 1048576);
}
...
TEST_F(CvarTest, NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS_value_2) {
  testIntValue("NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS", UINT64_MAX);
  EXPECT_EQ(NCCL_DDA2_ALLREDUCE_TREE_THRESHOLD_NVS, UINT64_MAX);
}
...
TEST_F(CvarTest, NCCL_DDA2_TMPBUFF_SIZE_value_0) {
  testIntValue("NCCL_DDA2_TMPBUFF_SIZE", 0);
  EXPECT_EQ(NCCL_DDA2_TMPBUFF_SIZE, 0);
}

TEST_F(CvarTest, NCCL_DDA2_TMPBUFF_SIZE_value_1) {
  testIntValue("NCCL_DDA2_TMPBUFF_SIZE", 9999);
  EXPECT_EQ(NCCL_DDA2_TMPBUFF_SIZE, 9999);
}

TEST_F(CvarTest, NCCL_DDA2_TMPBUFF_SIZE_value_2) {
  testIntValue("NCCL_DDA2_TMPBUFF_SIZE", UINT64_MAX);
  EXPECT_EQ(NCCL_DDA2_TMPBUFF_SIZE, UINT64_MAX);
}
...
TEST_F(CvarTest, NCCL_DDA_ALLREDUCE_TMPBUFF_SIZE_value_2) {
  testIntValue("NCCL_DDA_ALLREDUCE_TMPBUFF_SIZE", UINT64_MAX);
  EXPECT_EQ(NCCL_DDA_ALLREDUCE_TMPBUFF_SIZE, UINT64_MAX);
}
...
TEST_F(CvarTest, NCCL_DDA_ALLREDUCE_TREE_THRESHOLD_HCM_value_2) {
  testIntValue("NCCL_DDA_ALLREDUCE_TREE_THRESHOLD_HCM", UINT64_MAX);
  EXPECT_EQ(NCCL_DDA_ALLREDUCE_TREE_THRESHOLD_HCM, UINT64_MAX);
}
...
TEST_F(CvarTest, NCCL_DDA_ALLREDUCE_TREE_THRESHOLD_NVS_value_2) {
  testIntValue("NCCL_DDA_ALLREDUCE_TREE_THRESHOLD_NVS", UINT64_MAX);
  EXPECT_EQ(NCCL_DDA_ALLREDUCE_TREE_THRESHOLD_NVS, UINT64_MAX);
}
