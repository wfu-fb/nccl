...
TEST_F(CvarTest, NCCL_DDA2_TMPBUFF_SIZE_value_0) {
  testIntValue("NCCL_DDA2_TMPBUFF_SIZE", -100);
  EXPECT_EQ(NCCL_DDA2_TMPBUFF_SIZE, -100);
}
...
TEST_F(CvarTest, NCCL_DDA2_TMPBUFF_SIZE_value_3) {
  testIntValue("NCCL_DDA2_TMPBUFF_SIZE", INT_MAX);
  EXPECT_EQ(NCCL_DDA2_TMPBUFF_SIZE, INT_MAX);
}

TEST_F(CvarTest, NCCL_DDA2_TMPBUFF_SIZE_value_4) {
  testIntValue("NCCL_DDA2_TMPBUFF_SIZE", INT_MIN);
  EXPECT_EQ(NCCL_DDA2_TMPBUFF_SIZE, INT_MIN);
}
